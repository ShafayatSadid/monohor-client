...
const ProductCard = ({ product }) => {
    ...
    const handleAddToCart = (e) => {
        ...
        // Variant product হলে — detail page-এ পাঠাই
        if (productHasVariants) {
            window.location.href = `/products/${product.slug}`;
            return;
        }

        const result = addItem(product, 1, null);
        ...
        >
            <div className="relative aspect-square overflow-hidden bg-background">
                ...
                <button
                    ...
                    className={`absolute top-2 right-2 z-10 w-8 h-8 flex items-center justify-center rounded-full backdrop-blur-md transition ${
                        isWishlisted
